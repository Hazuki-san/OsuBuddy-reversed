...
namespace OsuParsers.Storyboards.Objects
{
	...
	public class StoryboardSample : IStoryboardObject
	{
		...
		// (get) Token: 0x060000C5 RID: 197 RVA: 0x00002491 File Offset: 0x00002491
		// (set) Token: 0x060000C6 RID: 198 RVA: 0x00002499 File Offset: 0x00002499
		public string FilePath { get; set; }

		// Token: 0x060000C7 RID: 199 RVA: 0x000024A2 File Offset: 0x000024A2
