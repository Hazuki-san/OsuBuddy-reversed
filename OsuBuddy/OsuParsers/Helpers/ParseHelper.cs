...
namespace OsuParsers.Helpers
{
	...
	{
		// Token: 0x0600015C RID: 348 RVA: 0x0000AF24 File Offset: 0x0000AF24
		...
		// Token: 0x0600015D RID: 349 RVA: 0x0000AF58 File Offset: 0x0000AF58
		...
		// Token: 0x0600015E RID: 350 RVA: 0x0000AFA0 File Offset: 0x0000AFA0
		...
		// Token: 0x0600015F RID: 351 RVA: 0x0000B04C File Offset: 0x0000B04C
		public static Color ParseColour(string line)
		{
			int[] array = (from c in line.Split(new char[]
			{
				','
			})
			select Convert.ToInt32(c)).ToArray<int>();
			return Color.FromArgb((array.Length == 4) ? array[3] : 255, array[0], array[1], array[2]);
		}

		// Token: 0x06000160 RID: 352 RVA: 0x0000B0B8 File Offset: 0x0000B0B8
		...
		// Token: 0x06000161 RID: 353 RVA: 0x00002A02 File Offset: 0x00002A02
		public static bool ToBool(this string value)
		{
			return value == "1" || value.ToLower() == "true";
		}

		// Token: 0x06000162 RID: 354 RVA: 0x00002A24 File Offset: 0x00002A24
		public static float ToFloat(this string value)
		{
			return float.Parse(value, NumberStyles.Float, CultureInfo.InvariantCulture);
		}

		// Token: 0x06000163 RID: 355 RVA: 0x00002A36 File Offset: 0x00002A36
